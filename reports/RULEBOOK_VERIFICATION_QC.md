...
- règles dont les exceptions sont renseignées : **3 / 58**
- anomalies relevées : **77**
...
|---|---|---|---|---|---|---|---|---|
| `AMF-R-001` | AMF | Position-recommandation AMF DOC-20 | Position-recommandation DOC-2020-03 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation ; source doctrinale : elle éclaire l'application d'un texte, elle ne vaut pas preuve p |
| `DORA-R-007` | DORA | Règlement (UE) 2022/2554 (DORA) | Article 18 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | affirmation négative « L'article 18 fixerait lui-même un nombre de clients affectés… » : sans chiffre à chercher, l'absence ne peut pas être établie mécaniquement ; exceptions jamais cherché |
| `DORA-R-008` | DORA | Règlement (UE) 2022/2554 (DORA) | Article 19 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | affirmation négative « Le règlement DORA de niveau 1 fixerait un délai de notificat… » : sans chiffre à chercher, l'absence ne peut pas être établie mécaniquement ; exceptions jamais cherché |
...
| `MIFID-R-007` | MIFID | Règlement délégué (UE) 2017/565 mo | Article 54 | 2020-01-01 | DRAFT | unknown | in_force | l'URL désigne l'acte 32021R1253 alors que la source cite 32017R0565 : vérification conduite contre l'acte cité ; la source dit l'acte modifié, mais aucune version consolidée au 2020-01-01 n' |
| `SFDR-R-003` | SFDR | Règlement (UE) 2019/2088 (SFDR) | Article 4 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | affirmation négative « L'article 4 fixerait lui-même un seuil chiffré d'encours déc… » : sans chiffre à chercher, l'absence ne peut pas être établie mécaniquement ; exceptions jamais cherché |
| `SFDR-R-008` | SFDR | Règlement (UE) 2019/2088 (SFDR) | Article 8 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | affirmation négative « L'article 8 imposerait une part minimale d'investissements d… » : sans chiffre à chercher, l'absence ne peut pas être établie mécaniquement ; exceptions jamais cherché |
| `AMF-R-004` | AMF | Position-recommandation AMF DOC-20 | Position-recommandation DOC-2020-03 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation ; source doctrinale : elle éclaire l'application d'un texte, elle ne vaut pas preuve p |
| `DORA-R-001` | DORA | Règlement (UE) 2022/2554 (DORA) | Article 2 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `DORA-R-002` | DORA | Règlement (UE) 2022/2554 (DORA) | Article 5 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `DORA-R-003` | DORA | Règlement (UE) 2022/2554 (DORA) | Article 6 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `DORA-R-010` | DORA | Règlement (UE) 2022/2554 (DORA) | Article 28 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `DORA-R-011` | DORA | Règlement (UE) 2022/2554 (DORA) | Article 30 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
...
| `MIFID-R-002` | MIFID | Directive 2014/65/UE (MIFID II) | Article 25 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `MIFID-R-003` | MIFID | Directive 2014/65/UE (MIFID II) | Article 25 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `MIFID-R-004` | MIFID | Directive 2014/65/UE (MIFID II) | Article 25 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `MIFID-R-006` | MIFID | Règlement délégué (UE) 2017/565, m | Article 2 et article 54 du règlement délégué (UE) 2017/565 modifié | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | l'URL désigne l'acte 32021R1253 alors que la source cite 32017R0565 : vérification conduite contre l'acte cité ; la source dit l'acte modifié, mais aucune version consolidée au 2020-01-01 n' |
| `SFDR-R-005` | SFDR | Règlement (UE) 2019/2088 (SFDR) | Article 6 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `SFDR-R-009` | SFDR | Règlement (UE) 2019/2088 (SFDR) | Article 9 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `TAXO-R-001` | SFDR | Règlement (UE) 2020/852 (Taxonomie | Article 3 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `TAXO-R-003` | SFDR | Règlement (UE) 2020/852 (Taxonomie | Articles 17 et 18 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | ancrage « Articles 17 et 18 » : 2 articles couverts (17, 18), à découper avant qu'un gold puisse le citer ; exceptions jamais cherchées : à trancher entre « listed » et « none_identified » a |
| `SFDR-R-001` | SFDR | Règlement (UE) 2019/2088 (SFDR) | Article 2 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | none_identified | in_force | — |
| `AMF-R-002` | AMF | Position-recommandation AMF DOC-20 | Position-recommandation DOC-2020-03 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation ; source doctrinale : elle éclaire l'application d'un texte, elle ne vaut pas preuve p |
| `AMF-R-003` | AMF | Position-recommandation AMF DOC-20 | Position-recommandation DOC-2020-03 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation ; source doctrinale : elle éclaire l'application d'un texte, elle ne vaut pas preuve p |
...
| `DORA-R-004` | DORA | Règlement (UE) 2022/2554 (DORA) | Articles 8 à 13 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | ancrage « Articles 8 à 13 » : 6 articles couverts (8, 9, 10, 11, 12, 13), à découper avant qu'un gold puisse le citer ; exceptions jamais cherchées : à trancher entre « listed » et « none_id |
| `DORA-R-005` | DORA | Règlement (UE) 2022/2554 (DORA) | Article 16 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `DORA-R-006` | DORA | Règlement (UE) 2022/2554 (DORA) | Article 17 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `DORA-R-009` | DORA | Règlement (UE) 2022/2554 (DORA) | Articles 24 à 26 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | ancrage « Articles 24 à 26 » : 3 articles couverts (24, 25, 26), à découper avant qu'un gold puisse le citer ; exceptions jamais cherchées : à trancher entre « listed » et « none_identified  |
| `DORA-R-012` | DORA | Règlement (UE) 2022/2554 (DORA) | Article 31 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
...
| `LCBFT-R-013` | LCBFT | Directive (UE) 2015/849, modifiée  | Ensemble de la directive | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | la source dit l'acte modifié, mais aucune version consolidée au 2020-01-01 n'existe (02015L0849-20200101) : la date de consolidation applicable doit être établie, sans quoi la règle est véri |
| `MIFID-R-001` | MIFID | Directive 2014/65/UE (MIFID II) | Article 24 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `MIFID-R-005` | MIFID | Directive 2014/65/UE (MIFID II) | Article 25 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `MIFID-R-008` | MIFID | Directive 2014/65/UE (MIFID II) | Article 16 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `MIFID-R-009` | MIFID | Directive 2014/65/UE (MIFID II) | Article 27 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `MIFID-R-010` | MIFID | Directive 2014/65/UE (MIFID II) | Article 9 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `MIFID-R-011` | MIFID | Règlement délégué (UE) 2017/565 | Article 54 | 2020-01-01 | DRAFT | unknown | in_force | énoncé peu corroboré par le texte cité (36% du vocabulaire retrouvé) : la règle parle peut-être d'autre chose ; exceptions jamais cherchées : à trancher entre « listed » et « none_identified |
| `SFDR-R-002` | SFDR | Règlement (UE) 2019/2088 (SFDR) | Article 3 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `SFDR-R-004` | SFDR | Règlement (UE) 2019/2088 (SFDR) | Article 5 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `SFDR-R-006` | SFDR | Règlement (UE) 2019/2088 (SFDR) | Article 7 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `SFDR-R-010` | SFDR | Règlement (UE) 2019/2088 (SFDR) | Article 10 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `SFDR-R-011` | SFDR | Règlement (UE) 2019/2088 (SFDR) | Article 11 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `SFDR-R-012` | SFDR | Règlement (UE) 2019/2088 (SFDR) | Article 12 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `SFDR-R-013` | SFDR | Règlement (UE) 2019/2088 (SFDR) | Article 13 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation |
| `SFDR-R-014` | SFDR | Règlement délégué (UE) 2022/1288 ( | Ensemble du règlement délégué | 2020-01-01 | REQUIRES_HUMAN_REVIEW | unknown | in_force | ancrage « Ensemble du règlement délégué » : aucun article désigné, la règle est vérifiée contre l'acte entier et aucun gold ne pourra citer sa disposition ; exceptions jamais cherchées : à t |
| `DORA-R-013` | DORA | Règlement (UE) 2022/2554 (DORA) | Article 64 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | none_identified | in_force | — |
| `TAXO-R-002` | SFDR | Règlement (UE) 2020/852 (Taxonomie | Article 9 | 2020-01-01 | REQUIRES_HUMAN_REVIEW | none_identified | in_force | — |

## Anomalies

### Exceptions jamais cherchées — 42
...
- `MIFID-R-007` : exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation
...
- `DORA-R-001` : exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation
...
- `DORA-R-011` : exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation
...
- `SFDR-R-009` : exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation
...
- `DORA-R-005` : exceptions jamais cherchées : à trancher entre « listed » et « none_identified » avant toute validation
